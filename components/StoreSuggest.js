...
export default function StoreSuggest({ familySize, annualIncome }) {
    ...
    useEffect(() => {
        const fetchRecommendation = async () => {
            ...
            Recommend 2-4 stores to customers based on their family size and income.
            ...
            const userPrompt = `Recommend 2-4 stores for a user with family size of ${familySize} and income of ${annualIncome} from the following list. Only pick stores with properly formatted names.
